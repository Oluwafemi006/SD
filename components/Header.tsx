...
export default function Header() {
  ...
  return <header className="sticky top-0 z-50 border-b border-slate-200/90 bg-white/95 backdrop-blur-xl"><div className="site-container flex h-[88px] items-center justify-between gap-6">
    <Link href="/" className="relative block h-[72px] w-[112px] shrink-0" aria-label="SD International Group, accueil"><Image src="/images/logo-sd-international-new.png" alt="Logo SD International Group" fill priority sizes="112px" className="object-contain" /></Link>
