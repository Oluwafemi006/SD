...
export default function Footer() { return <footer className="bg-[#071827] py-16 text-slate-300"><div className="site-container"><div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
  <div><Link href="/" className="relative block h-[110px] w-[165px] overflow-hidden rounded-md bg-navy" aria-label="SD International Group, accueil"><Image src="/images/logo-sd-international-new.png" alt="Logo SD International Group" fill sizes="165px" className="object-contain" /></Link><p className="mt-5 text-sm leading-7">Des compétences complémentaires pour accompagner les projets, les opérations et les besoins d’approvisionnement.</p></div>
